...
- Is there a difference between elderly people and experts in their evaluation of walkability from elderly people perspective? (Opentional)
...
- Semantic segmentation
  - Employ Cityscapes and ADE20K as pretrained datasets
  - DeepLabV3 and ResNeSt will be used to extract features from SVIs
  
- Walkability index model selection
  - Based on R-square and MAE
