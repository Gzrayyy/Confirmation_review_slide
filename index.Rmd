...
<script>
  ...
  window.addEventListener("DOMContentLoaded", function () {
    ...
    logo.src = "img/Primary logo.png";  // 建议图片别带空格
    logo.alt = "University of Sheffield Logo";
    logo.id = "corner-logo";
...
/* ✅ 隐藏在反色 slide 上 */
.remark-slide-container .inverse ~ #corner-logo,
.remark-slide-container .remark-slide-content.inverse ~ #corner-logo {
  opacity: 0 !important;
  pointer-events: none;
}
</style>
